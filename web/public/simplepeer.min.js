  ...
  })()(
    {
        ...
        function(e, t, n) {
          ...
          function f(e) {
            ...
            if (e) {
              if (ArrayBuffer.isView(e) || "length" in e)
                return "number" != typeof e.length || G(e.length) ? a(0) : p(e);
          ...
          function y(e, t, n, r, a) {
            ...
            if (a) {
              var p = -1;
              for (c = n; c < d; c++)
                if (o(e, c) !== o(t, -1 === p ? 0 : c - p))
                  -1 !== p && (c -= c - p), (p = -1);
                else if ((-1 === p && (p = c), c - p + 1 === l)) return p * s;
            } else
            ...
            for (var r = [], a = t; a < n; ) {
              ...
              if (a + d <= n) {
                ...
                1 === d
                  ...
                  ? ((l = e[a + 1]),
                    128 == (192 & l) &&
                      ((u = ((31 & o) << 6) | (63 & l)), 127 < u && (s = u)))
                  : 3 === d
                  ? ((l = e[a + 1]),
                    (c = e[a + 2]),
                    128 == (192 & l) &&
                      128 == (192 & c) &&
                      ((u = ((15 & o) << 12) | ((63 & l) << 6) | (63 & c)),
          ...
          function T(e) {
            ...
            for (var n = "", r = 0; r < t; )
              n += V.apply(String, e.slice(r, (r += 4096)));
            return n;
          }
          function A(e, t, n) {
            var r = "";
          ...
          (n.kMaxLength = 2147483647),
            ...
            (o.compare = function(e, t) {
              ...
              if (e === t) return 0;
              for (
                var n = e.length, r = t.length, a = 0, s = K(n, r);
                a < s;
                ++a
              )
                if (e[a] !== t[a]) {
          ...
          (o.prototype.slice = function(e, t) {
            ...
            (o.prototype.fill = function(e, t, n, r) {
              ...
              if ("number" == typeof e) for (s = t; s < n; ++s) this[s] = e;
                ...
                var d = o.isBuffer(e) ? e : new o(e, r),
                  l = d.length;
                if (0 === l)
                  throw new TypeError(
        ...
        function(e, t) {
          function n() {
            (this._events &&
              ...
              ((this._events = b(null)), (this._eventsCount = 0)),
          ...
          function s(e, t, n, r) {
            if (t) e.call(n, r);
              ...
              for (var a = e.length, o = _(e, a), s = 0; s < a; ++s)
                o[s].call(n, r);
          }
          function d(e, t, n, r, a) {
            if (t) e.call(n, r, a);
            else
              for (var o = e.length, s = _(e, o), d = 0; d < o; ++d)
                s[d].call(n, r, a);
          }
          function l(e, t, n, r, a, o) {
            if (t) e.call(n, r, a, o);
            else
              for (var s = e.length, d = _(e, s), l = 0; l < s; ++l)
                d[l].call(n, r, a, o);
          }
          function c(e, t, n, r) {
            if (t) e.apply(n, r);
            ...
            if (
              ...
              i
                ? (i.newListener &&
                    ...
                    (i = e._events)),
                  (s = i[t]))
                : ((i = e._events = b(null)), (e._eventsCount = 0)),
              !s)
            )
              ...
              ("function" == typeof s
                ...
                ? s.unshift(n)
                : s.push(n),
              !s.warned && ((o = r(e)), o && 0 < o && s.length > o))
            ) {
              s.warned = !0;
              var d = new Error(
              ...
              (d.name = "MaxListenersExceededWarning"),
                ...
                "object" == typeof console &&
                  console.warn &&
                  console.warn("%s: %s", d.name, d.message);
            }
            return e;
          }
          function u() {
              ...
              for (
                o = n(o),
                  isNaN(o) || o === 1 / 0
                    ...
                    : ((_ = t(h(o) / g)),
                      1 > o * (y = r(2, -_)) && (_--, (y *= 2)),
                      (o += 1 <= _ + S ? v / y : v * r(2, 1 - S)),
                      2 <= o * y && (_++, (y /= 2)),
                      _ + S >= w
                        ? ((b = 0), (_ = w))
                        : 1 <= _ + S
                        ? ((b = (o * y - 1) * r(2, u)), (_ += S))
                        : ((b = o * r(2, S - 1) * r(2, u)), (_ = 0)));
                8 <= u;
                a[l + R] = 255 & b, R += E, b /= 256, u -= 8
              );
              for (
                _ = (_ << u) | b, C += u;
                0 < C;
                a[l + R] = 255 & _, R += E, _ /= 256, C -= 8
              );
              a[l + R - E] |= 128 * d;
            });
        },
                ...
                : {
                    nextTick: function(t, n, r, a) {
                      ...
                      switch (d) {
                        ...
                        default:
                          for (o = Array(d - 1), s = 0; s < o.length; )
                            o[s++] = arguments[s];
                          return e.nextTick(function() {
                            t.apply(null, o);
                          });
      ...
      17: [
        function(e, t) {
          ...
          var o = e("process-nextick-args").nextTick,
            i =
              Object.keys ||
              function(e) {
                var t = [];
      ...
      18: [
        ...
        { "./_stream_transform": 20, "core-util-is": 5, inherits: 11 }
      ],
      19: [
        function(e, n) {
          (function(r, a) {
            ...
            function l(t) {
              return (
                ...
                this instanceof l
                  ? void ((this._readableState = new d(t, this)),
                    (this.readable = !0),
                    t &&
              ...
              if (null === t) (i.reading = !1), _(e, i);
                ...
                a || (s = u(i, t)),
                  s
                    ...
                    ? ("string" != typeof t &&
                        !i.objectMode &&
                        Object.getPrototypeOf(t) !== j.prototype &&
                        (t = o(t)),
                      r
                        ? i.endEmitted
                          ? e.emit(
            ...
            function T(e, t) {
              ...
              for (e -= o.length; (r = r.next); ) {
                ...
                if (
                  ((o += s === i.length ? i : i.slice(0, e)), (e -= s), 0 === e)
                ) {
                  s === i.length
                    ? (++a, (t.head = r.next ? r.next : (t.tail = null)))
            ...
            function A(e, t) {
              ...
              for (a.data.copy(r), e -= a.data.length; (a = a.next); ) {
                ...
                if ((i.copy(r, r.length - e, 0, s), (e -= s), 0 === e)) {
                  s === i.length
                    ? (++o, (t.head = a.next ? a.next : (t.tail = null)))
                    : ((t.head = a), (a.data = i.slice(s)));
                  break;
                }
                ++o;
              }
            ...
            (l.prototype.read = function(e) {
              ...
              if (
                ...
                return (
                  ...
                  0 === t.length && t.ended ? L(this) : m(this),
                  null
                );
              ...
              H("need readable", a),
                (0 === t.length || t.length - e < t.highWaterMark) &&
                  ((a = !0), H("length less than watermark", a)),
                t.ended || t.reading
                  ? ((a = !1), H("reading or ended", a))
                  : a &&
                    (H("do read"),
                    (t.reading = !0),
                    (t.sync = !0),
              ...
              (l.prototype.on = function(e, t) {
                ...
                if ("data" === e)
                  ...
                  r.endEmitted ||
                    ...
                    (r.emittedReadable = !1),
                    r.reading ? r.length && m(this) : I(S, this));
                }
                return n;
              }),
      ...
      20: [
        ...
        { "./_stream_duplex": 17, "core-util-is": 5, inherits: 11 }
      ],
      21: [
        function(e, n) {
          (function(r, a) {
            ...
            function c(t) {
              return (
                ...
                P.call(c, this) || this instanceof A
                  ? void ((this._writableState = new l(t, this)),
                    (this.writable = !0),
                    t &&
            ...
            function w(e, t) {
              ...
              if (e._writev && n && n.next) {
                ...
                i.entry = n;
                for (var s = 0, d = !0; n; )
                  (a[s] = n), n.isBuf || (d = !1), (n = n.next), (s += 1);
                (a.allBuffers = d),
                  h(e, t, !0, t.length, a, "", i.finish),
                  t.pendingcb++,
            ...
            function R(e, t) {
              t.prefinished ||
                ...
                ("function" == typeof e._final
                  ? (t.pendingcb++, (t.finalCalled = !0), T(v, e, t))
            ...
            function k(e, t, n) {
              (t.ending = !0),
                E(e, t),
                n && (t.finished ? T(n) : e.once("finish", n)),
                (t.ended = !0),
                (e.writable = !1);
            }
            function x(e, t, n) {
              ...
              ? ((P = Function.prototype[Symbol.hasInstance]),
                Object.defineProperty(c, Symbol.hasInstance, {
                  value: function(e) {
                    return (
                      !!P.call(this, e) ||
                      (!(this !== c) && e && e._writableState instanceof l)
                    );
                  }
                }))
              : (P = function(e) {
              ...
              (c.prototype.write = function(e, t, n) {
                ...
                return (
                  ...
                  r.ended
                    ? p(this, n)
                    : (o || u(this, r, e, n)) &&
                      (r.pendingcb++, (a = g(this, r, o, e, t, n))),
                  a
                );
              }),
            ...
            return (
              ...
              (e.prototype.concat = function(e) {
                ...
                for (var t = a.allocUnsafe(e >>> 0), n = this.head, o = 0; n; )
                  r(n.data, t, o), (o += n.data.length), (n = n.next);
                return t;
              }),
              e
            );
          ...
          (function(n) {
            function r(e) {
              ...
              if (
                ...
                (t.iceCompleteTimeout = e.iceCompleteTimeout || 5000),
                (t.destroyed = !1),
                (t.connected = !1),
            ...
            d(r, c.Duplex),
              ...
              (r.prototype._addIceCandidate = function(e) {
                var t = this;
                t._pc
                  .addIceCandidate(new t._wrtc.RTCIceCandidate(e))
                  .catch(function(e) {
                    return "closed" !== t._pc.signalingState &&
                      "Failed to set ICE candidate; RTCPeerConnection is closed." ===
                        e.message
                      ? t._debug("ignoring incorrect wrtc error")
                      : void t.destroy(o(e, "ERR_ADD_ICE_CANDIDATE"));
                  });
              }),
              ...
              (r.prototype.addTransceiver = function(e, t) {
                var n = this;
                if ((n._debug("addTransceiver()"), n.initiator))
                  try {
              ...
              (r.prototype.addTrack = function(e, t) {
                var n = this;
                n._debug("addTrack()");
                var r = n._senderMap.get(e) || new Map(),
                  a = r.get(t);
                a
                  ? a.removed
                    ? n.destroy(
                    ...
                    : n.destroy(
                        o("Track has already been added to that stream."),
                        "ERR_SENDER_ALREADY_ADDED"
                      )
                  : ((a = n._pc.addTrack(e, t)),
                    r.set(t, a),
                    n._senderMap.set(e, r),
                    n._needsNegotiation());
              }),
              (r.prototype.replaceTrack = function(e, t, n) {
                var r = this;
                r._debug("replaceTrack()");
                var a = r._senderMap.get(e),
                  i = a ? a.get(n) : null;
                i ||
                  r.destroy(
                    o("Cannot replace track that was never added."),
                    "ERR_TRACK_NOT_ADDED"
                  ),
                  t && r._senderMap.set(t, a),
                  null == i.replaceTrack
                    ? r.destroy(
                        o(
              ...
              (r.prototype.removeTrack = function(e, t) {
                ...
                try {
                  ...
                  "NS_ERROR_UNEXPECTED" === e.name
                    ? n._sendersAwaitingStable.push(a)
                    : n.destroy(e);
                }
                n._needsNegotiation();
              }),
                    ...
                    t.getStats(function(n, r) {
                      function a(e) {
                        ...
                        n && (n.ip || n.address)
                          ...
                          : "string" == typeof e.googLocalAddress &&
                            ...
                            (t.localPort = +n[1])),
                          t.localAddress &&
                            (t.localFamily = t.localAddress.includes(":")
                              ? "IPv6"
                              : "IPv4");
                        var r = i[e.remoteCandidateId];
                        r && (r.ip || r.address)
                          ? ((t.remoteAddress = r.ip || r.address),
                            (t.remotePort = +r.port))
                          : r && r.ipAddress
                          ...
                          : "string" == typeof e.googRemoteAddress &&
                            ...
                            (t.remotePort = +r[1])),
                          t.remoteAddress &&
                            (t.remoteFamily = t.remoteAddress.includes(":")
                              ? "IPv6"
                              : "IPv4"),
                          t._debug(
                      ...
                      if (!t.destroyed) {
                        ...
                        if (
                          ...
                          !l &&
                            (!Object.keys(d).length || Object.keys(s).length))
                        )
              ...
              (r.prototype._onIceCandidate = function(e) {
                ...
                t.destroyed ||
                  ...
                  e.candidate && t._startIceCompleteTimeout());
              }),
